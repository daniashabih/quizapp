                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative flex items-center">
                        ...
                        <select
                            ...
                            className="pl-8 pr-8 py-2 text-xs font-semibold bg-[var(--muted-bg)] text-[var(--foreground)] border border-[var(--card-border)] rounded-xl focus:outline-none focus:border-[#289B7D] cursor-pointer appearance-none"
                        >
                            {categories.map(cat => (
                    ...
                    <div className="relative flex-1 min-w-[220px]">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-9 py-2 text-xs font-medium bg-[var(--muted-bg)] text-[var(--foreground)] border border-[var(--card-border)] rounded-xl focus:outline-none focus:border-[#289B7D] focus:ring-2 focus:ring-[#289B7D]/20 transition-all placeholder:text-[var(--foreground-muted)]"
                        />
                        {searchQuery && (
                            <button
            ...
            {top3.length >= 3 && !searchQuery && category === 'All' && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="order-2 md:order-1 bg-[var(--card-bg)] border border-slate-300/60 dark:border-slate-700 rounded-3xl p-6 text-center shadow-lg relative flex flex-col items-center group hover:-translate-y-1 transition-all duration-300"
                    >
                        <div className="absolute -top-4 px-3 py-1 bg-gradient-to-r from-slate-300 to-slate-400 text-slate-900 text-[10px] font-extrabold uppercase rounded-full shadow-md flex items-center gap-1">
                            <Medal size={12} /> 2nd Place
                        </div>

                        <div className="relative mt-2 mb-4">
                            <div className="w-20 h-20 rounded-2xl overflow-hidden ring-4 ring-slate-300 dark:ring-slate-700 shadow-xl bg-slate-200">
                                <img
                                    src={top3[1].avatar}
                                    alt={top3[1].name}
                        ...
                        <div className="w-full bg-[var(--muted-bg)] rounded-2xl p-3 border border-[var(--card-border)] grid grid-cols-2 gap-2 text-center">
                            <div>
                                ...
                                <p className="text-sm font-extrabold text-slate-600 dark:text-slate-300">{top3[1].xp.toLocaleString()}</p>
                            </div>
                            <div>
                                <p className="text-[10px] uppercase tracking-wider text-[var(--foreground-muted)] font-semibold">Accuracy</p>
                                <p className="text-sm font-extrabold text-emerald-500">{top3[1].score}%</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-3 flex items-center gap-2 text-xs font-semibold text-[var(--foreground-secondary)]">
                            ...
                            <span>•</span>
                            <span className="flex items-center gap-1"><Award size={13} className="text-[#289B7D]" /> {top3[1].certs} Certs</span>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="order-1 md:order-2 bg-gradient-to-b from-[#163B34] to-[#0F2823] text-white border-2 border-amber-400/80 rounded-3xl p-7 text-center shadow-2xl relative flex flex-col items-center group hover:-translate-y-2 transition-all duration-300 md:-translate-y-4"
                    >
                        <div className="absolute -top-5 px-4 py-1.5 bg-gradient-to-r from-amber-300 via-amber-400 to-yellow-500 text-amber-950 text-xs font-black uppercase rounded-full shadow-xl flex items-center gap-1.5 animate-pulse">
                            <Trophy size={14} className="fill-amber-950" /> 1st Place Champion
                        </div>

                        <div className="relative mt-3 mb-4">
                            <div className="w-24 h-24 rounded-2xl overflow-hidden ring-4 ring-amber-400 shadow-2xl bg-amber-100">
                                <img
                                    src={top3[0].avatar}
                                    alt={top3[0].name}
                                    className="w-full h-full object-cover"
                        ...
                        <p className="text-xs text-amber-200/90 font-medium mb-4">{top3[0].role}</p>
                        ...
                        <div className="w-full bg-white/10 backdrop-blur-md rounded-2xl p-3.5 border border-white/20 grid grid-cols-2 gap-2 text-center">
                            <div>
                                <p className="text-[10px] uppercase tracking-wider text-amber-200/80 font-bold">Total XP</p>
                                <p className="text-base font-black text-amber-300">{top3[0].xp.toLocaleString()}</p>
                            </div>
                            <div>
                                <p className="text-[10px] uppercase tracking-wider text-amber-200/80 font-bold">Accuracy</p>
                                <p className="text-base font-black text-emerald-300">{top3[0].score}%</p>
                            </div>
                        </div>

                        <div className="mt-4 flex items-center justify-center gap-3 text-xs font-bold text-amber-100">
                            <span className="flex items-center gap-1 bg-amber-400/20 px-2.5 py-1 rounded-full border border-amber-400/30">
                                <Flame size={14} className="text-amber-400 fill-amber-400" /> {top3[0].streak} Day Streak
                            </span>
                            <span className="flex items-center gap-1 bg-emerald-400/20 px-2.5 py-1 rounded-full border border-emerald-400/30 text-emerald-200">
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="order-3 bg-[var(--card-bg)] border border-amber-700/40 rounded-3xl p-6 text-center shadow-lg relative flex flex-col items-center group hover:-translate-y-1 transition-all duration-300"
                    >
                        <div className="absolute -top-4 px-3 py-1 bg-gradient-to-r from-amber-600 to-amber-700 text-white text-[10px] font-extrabold uppercase rounded-full shadow-md flex items-center gap-1">
                            <Medal size={12} /> 3rd Place
                        </div>

                        <div className="relative mt-2 mb-4">
                            <div className="w-20 h-20 rounded-2xl overflow-hidden ring-4 ring-amber-700/50 shadow-xl bg-amber-900/10">
                                <img
                                    src={top3[2].avatar}
                                    alt={top3[2].name}
                                    className="w-full h-full object-cover"
                        ...
                        <div className="w-full bg-[var(--muted-bg)] rounded-2xl p-3 border border-[var(--card-border)] grid grid-cols-2 gap-2 text-center">
                            <div>
                                <p className="text-[10px] uppercase tracking-wider text-[var(--foreground-muted)] font-semibold">XP Score</p>
                                <p className="text-sm font-extrabold text-amber-700 dark:text-amber-400">{top3[2].xp.toLocaleString()}</p>
                            </div>
                            <div>
                                <p className="text-[10px] uppercase tracking-wider text-[var(--foreground-muted)] font-semibold">Accuracy</p>
                                <p className="text-sm font-extrabold text-emerald-500">{top3[2].score}%</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-3 flex items-center gap-2 text-xs font-semibold text-[var(--foreground-secondary)]">
                            ...
                            <span>•</span>
                            <span className="flex items-center gap-1"><Award size={13} className="text-[#289B7D]" /> {top3[2].certs} Certs</span>
                        </div>
                    </motion.div>
                </motion.div>
            )}
            ...
            <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl shadow-xs overflow-hidden">
                <div className="px-6 py-4 border-b border-[var(--card-border)] flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-wrap">
                        <Users size={18} className="text-[#289B7D]" />
                        <h2 className="font-display font-bold text-base text-[var(--foreground)]">
                            Overall Leaderboard ({filteredPerformers.length})
                        </h2>
                        {searchQuery && (
                            <span className="px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#289B7D]/10 text-[#289B7D] border border-[#289B7D]/20">
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        >
                            {filteredPerformers.map((user) => {
                                ...
                                if (user.rank === 1) {
                                    rankBadge = (
                                        <span className="w-8 h-8 rounded-xl bg-amber-400 text-amber-950 font-black text-xs flex items-center justify-center mx-auto shadow-sm">
                                            🥇
                                        </span>
                                    );
                                } else if (user.rank === 2) {
                                    rankBadge = (
                                        <span className="w-8 h-8 rounded-xl bg-slate-300 text-slate-800 font-black text-xs flex items-center justify-center mx-auto shadow-sm">
                                            🥈
                                        </span>
                                    );
                                } else if (user.rank === 3) {
                                    rankBadge = (
                                        <span className="w-8 h-8 rounded-xl bg-amber-700 text-white font-black text-xs flex items-center justify-center mx-auto shadow-sm">
                                            🥉
                                        </span>
                                    );
                                }
                                ...
                                return (
                                    <motion.tr
                                        ...
                                        className={`group hover:bg-[var(--muted-bg)]/80 transition-colors ${
                                            isCurrentUser ? 'bg-[#163B34]/10 border-l-4 border-l-[#289B7D]' : ''
                                        }`}
                                    >
                                        {/* Rank Column */}
                                        ...
                                        <td className="px-5 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="relative w-10 h-10 rounded-xl overflow-hidden bg-[var(--muted-bg)] border border-[var(--card-border)] shrink-0">
                                                    <img
                                                        src={user.avatar}
                                                        alt={user.name}
                                                        className="w-full h-full object-cover"
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        <span className="font-bold text-sm text-[var(--foreground)] group-hover:text-[#289B7D] transition-colors">
                                                            {user.name}
                                                        </span>
                                                        {isCurrentUser && (
                                                            <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-[#289B7D] text-white">
                                                                YOU
                                                            </span>
                                                        )}
                                                    </div>
                                        ...
                                        {/* Certificates */}
                                        <td className="px-5 py-4 text-center">
                                            <span className="inline-flex items-center gap-1 text-xs font-bold text-[#163B34] dark:text-emerald-400">
                    ...
                    {filteredPerformers.length === 0 && (
                        <div className="p-12 text-center">
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-[#163B34] text-white hover:bg-[#289B7D] transition-colors cursor-pointer"
                            >
