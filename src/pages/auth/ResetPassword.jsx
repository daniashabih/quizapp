                ...
                <div className="w-full max-w-md animate-fade-up">
                    <div className="card p-6 sm:p-8 rounded-2xl">
                        <div className="text-center mb-6">
                            <div className="w-12 h-12 rounded-2xl bg-[#F3E5C5] border border-[#E2D0A6] flex items-center justify-center mx-auto mb-3">
                                <Lock size={22} className="text-[#193D35]" />
                            </div>
                        ...
                        <div className="mt-4 text-center">
                            <Link to="/login" className="text-xs font-semibold text-[#193D35] hover:text-[#122C26] transition-colors inline-flex items-center gap-1">
