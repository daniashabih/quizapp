    ...
    if (loading) return (
        <div className="min-h-screen bg-[var(--page-bg)] flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center">
                <Loader2 size={40} className="animate-spin text-[#059669] mx-auto mb-4" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="relative max-w-md mx-auto mb-6">
                        ...
                        <input type="text" placeholder="Search technologies..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
                            className="w-full bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl py-2.5 pl-10 pr-4 text-xs sm:text-sm text-[var(--foreground)] placeholder-[var(--foreground-muted)] focus:outline-none focus:ring-2 focus:ring-[#059669]/20 focus:border-[#059669] transition-all" />
                    </div>
                            ...
                            {filtered.map((cat) => {
                                ...
                                return (
                                    <button key={cat.id}
                                        ...
                                        className="group bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-5 text-left hover:border-[#059669] hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                        ...
                                        <h3 className="text-lg font-display font-bold text-[var(--foreground)] mb-1 group-hover:text-[#059669] transition-colors">{cat.name}</h3>
                                        ...
                                        <div className="flex items-center gap-1 pt-2.5 text-xs font-semibold text-[#059669] group-hover:gap-2 transition-all">
